...
public class SetupDefaultCitationsStep implements ProvisionStep {

    private final ExternalOrganizationClient client;

    @Override
    public StepName name() {
        return StepName.SETUP_DEFAULT_CITATIONS;
    }
    ...
    public boolean shouldRun(ProvisionContext context) {
        return context.hasSection(ConfigSections.CITATIONS);
    }

    @Override
    public void execute(ProvisionContext context) {
        client.setupDefaultCitations(context.getOrganizationId());
    }
}
